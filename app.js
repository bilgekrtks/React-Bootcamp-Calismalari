...
/*products.forEach((product, index) => {
         ...
         if (product.categoryId !== 2 && product.unitPrice > 30) {
            console.log(product);
         }
        })
*/
...
*/
//const findProduct = products.find(q => q.id === 5);
//const findProduct = products.filter(q=>q.categoryId!==2 && q.unitPrice >30);
//const findProduct = products.filter(q => q.unitsInStock === 0);
...
const result=products.sort((a,b)=>b.unitPrice-a.unitPrice)[products.length-1]
console.log(result)
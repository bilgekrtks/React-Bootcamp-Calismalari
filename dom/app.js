...
// aElement.setAttribute('style', 'font-size:25px') // fontsize böyle ayarlanırsa sıkıntı çıkarır 
...
// // elem.classList.toggle('test')
// const res = elem.classList.contains('test')
